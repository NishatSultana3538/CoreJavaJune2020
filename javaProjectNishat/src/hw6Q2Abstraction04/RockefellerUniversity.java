...
public class RockefellerUniversity extends EngineeringSchool implements AeronauticalSchool{
	...
	public RockefellerUniversity() {
		System.out.println("This is from default constructor from RockefellerUniversity class ");
	}//this is a default constructor, which have to have the same name as class
	
	public void statistics() {
		System.out.println("This statistics method  is from RockefellerUniversity class");
	}

	@Override
	public void aeronauticalInfo() {
		System.out.println("This aeronauticalInfos method  is from AeronauticalSchool Interface");
	...
	public void computerLab() {
		System.out.println("This computerLab method  is from abstract class EngineeringSchoo");
